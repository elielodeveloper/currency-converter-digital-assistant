...
> Generated by `@oracle/bots-node-sdk` on **Fri Oct 23 2020**
...
curl -H "Content-Type: application/json" -d @./spec/test.cc.req.json localhost:3000/components/CurrencyConverter

# invoke resolve entity event handler component
curl -H "Content-Type: application/json" -d @./spec/test.eh.req.json localhost:3000/components/resolveentities/CurrencyConverter
```
